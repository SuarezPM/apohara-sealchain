/* @ts-self-types="./sealchain_wasm.d.ts" */
 ...
 * @returns {any}
 */
export function verify_receipt(file_bytes, receipt_json) {
    const ptr0 = passArray8ToWasm0(file_bytes, wasm.__wbindgen_export2);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(receipt_json, wasm.__wbindgen_export2, wasm.__wbindgen_export3);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('sealchain_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
